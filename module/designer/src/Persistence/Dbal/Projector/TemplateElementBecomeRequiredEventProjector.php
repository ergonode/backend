...
/**
 */
class TemplateElementBecomeRequiredEventProjector implements DomainEventProjectorInterface
{
    ...
    {
        return $event instanceof TemplateElementBecomeRequiredEvent;
    }
    ...
    public function projection(AbstractId $aggregateId, DomainEventInterface $event): void
    {
        ...
        if (!$event instanceof TemplateElementBecomeRequiredEvent) {
            throw new UnsupportedEventException($event, TemplateElementBecomeRequiredEvent::class);
        }
