Feature: Category module
  ...
  Scenario Outline: Create category with invalid data (<message>)
    ...
    Examples:
      ...
      | errors.name.en_EN[0] | {"en_EN":"iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii  "}                                           | "Code"      | Category name is too long. It should contain 128 characters or less.|
