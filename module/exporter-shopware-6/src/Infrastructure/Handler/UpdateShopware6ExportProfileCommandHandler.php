...
class UpdateShopware6ExportProfileCommandHandler
{
    ...
    public function __invoke(UpdateShopware6ExportProfileCommand $command)
    {
        ...
        $exportProfile->setProductDescription($command->getProductDescription());
        $exportProfile->setCategoryTree($command->getCategoryTree());
        $exportProfile->setPropertyGroup($command->getPropertyGroup());
        $exportProfile->setCustomField($command->getCustomField());
