...
class AbstractShopware6ProductCrossSellingAssignedTest extends TestCase
{
    private string $id;
    ...
    private function getClass(): AbstractShopware6ProductCrossSellingAssigned
    {
        return new class(
            $this->id,
            $this->productId,
            $this->position
        ) extends AbstractShopware6ProductCrossSellingAssigned {
        };
    }
}
