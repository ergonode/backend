...
use Ergonode\ExporterShopware6\Domain\Builder\Shopware6CreateExportProfileCommandBuilder;
...
/**
 */
class Shopware6CreateExportProfileCommandBuilderTest extends TestCase
{
    /**
     */
    public function testSupport(): void
    {
        $builder = new Shopware6CreateExportProfileCommandBuilder();
    ...
    public function testBuild(): void
    {
        ...
        $builder = new Shopware6CreateExportProfileCommandBuilder();
        /** @var CreateShopware6ExportProfileCommand $result */
        $result = $builder->build($form);
        $this->assertInstanceOf(CreateShopware6ExportProfileCommand::class, $result);
