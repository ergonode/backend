...
use Ergonode\Multimedia\Domain\Command\DownloadMultimediaCommand;

/**
 */
class DownloadMultimediaCommandHandler
{
    /**
    ...
    /**
     * @param DownloadMultimediaCommand $command
     *
     * @throws \Exception
     */
    public function __invoke(DownloadMultimediaCommand $command)
    {
        $id = $command->getId();
        $url = $command->getUrl();
