...
use Ergonode\Multimedia\Infrastructure\Provider\AvatarExtensionProvider;
...
/**
 */
class AvatarExtensionValidator extends ConstraintValidator
{
    /**
    ...
    {
        if (!$constraint instanceof AvatarExtension) {
