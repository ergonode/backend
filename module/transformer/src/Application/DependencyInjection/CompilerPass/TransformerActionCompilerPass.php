...
{
    public const TAG = 'component.transformer_action.transformer_interface';
    ...
    {
        if ($container->has(ImportActionProvider::class)) {
    ...
    {
        $arguments = [];
        $definition = $container->findDefinition(ImportActionProvider::class);
