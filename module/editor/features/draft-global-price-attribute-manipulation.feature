Feature: Draft edit and inheritance value for product draft with price attribute
  ...
  Scenario: Edit product price value in "en_GB" language
  ...
  Scenario: Edit product price value in "pl_PL" language
  ...
  Scenario: Edit product price value (zero) in "en_GB" language
    When I send a PUT request to "api/v1/en_GB/products/@product_id@/draft/@attribute_id@/value" with body:
      """
      {
        "value": 0
