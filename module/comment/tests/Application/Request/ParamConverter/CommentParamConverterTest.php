...
namespace Ergonode\Comment\Tests\Application\Request\ParamConverter;

use Ergonode\Comment\Domain\Entity\Comment;
use Ergonode\Comment\Domain\Repository\CommentRepositoryInterface;
use Ergonode\Comment\Application\Request\ParamConverter\CommentParamConverter;
...
/**
 */
class CommentParamConverterTest extends TestCase
{
    /**
    ...
    public function testSupportedClass(): void
    {
        ...
        $this->configuration->method('getClass')->willReturn(Comment::class);
    ...
    {
        $this->request->method('get')->willReturn(Uuid::uuid4()->toString());
        $this->repository->method('load')->willReturn($this->createMock(Comment::class));
