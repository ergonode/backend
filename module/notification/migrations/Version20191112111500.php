...
final class Version20191112111500 extends AbstractErgonodeMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_notification ADD CONSTRAINT user_notifications_notification_fk FOREIGN KEY (notification_id) REFERENCES notification ON DELETE CASCADE ');
    }
}
