...
use Ergonode\Account\Application\Request\ParamConverter\RoleParamConverter;
...
/**
 */
class RoleParamConverterTest extends TestCase
{
    /**
    ...
    public function testSupportedClass(): void
    {
        ...
        $this->configuration->method('getClass')->willReturn(Role::class);

        $paramConverter = new RoleParamConverter($this->repository);
    ...
    {
        $this->request->method('get')->willReturn(Uuid::uuid4()->toString());
        $this->repository->method('load')->willReturn($this->createMock(Role::class));
