...
/**
 */
class NoteCreatedEventProjector implements DomainEventProjectorInterface
{
    ...
    {
        return $event instanceof NoteCreatedEvent;
    }
    ...
    public function projection(AbstractId $aggregateId, DomainEventInterface $event): void
    {
        if (!$this->supports($event)) {
            throw new UnsupportedEventException($event, NoteCreatedEvent::class);
        }
