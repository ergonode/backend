...
namespace Ergonode\Note\Tests\Infrastructure\JMS\Serializer\Handler;

use Ergonode\Note\Domain\Entity\NoteId;
use Ergonode\Note\Infrastructure\JMS\Serializer\Handler\NoteIdHandler;
...
class NoteIdHandlerTest extends TestCase
{
    ...
    {
        $this->handler = new NoteIdHandler();
    ...
    {
        $configurations = NoteIdHandler::getSubscribingMethods();
