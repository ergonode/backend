        ...
        $grid
            ...
            ->addColumn('_links', new LinkColumn('hal', [
                'get' => [
                    ...
                    'privilege' => 'ERGONODE_ROLE_PRODUCT_COLLECTION_GET_TYPE',
                ],
                'edit' => [
                    'route' => 'ergonode_product_collection_type_change',
                    'parameters' => ['language' => $language->getCode(), 'productCollectionType' => '{id}'],
                    'method' => Request::METHOD_PUT,
                    'privilege' => 'ERGONODE_ROLE_PRODUCT_COLLECTION_PUT_TYPE',
                ],
                'delete' => [
                    'route' => 'ergonode_product_collection_type_delete',
                    'parameters' => ['language' => $language->getCode(), 'productCollectionType' => '{id}'],
                    'method' => Request::METHOD_DELETE,
                    'privilege' => 'ERGONODE_ROLE_PRODUCT_COLLECTION_DELETE_TYPE',
                ],
            ]))
            ->orderBy('code', 'DESC');
