Feature: Product collection module
  ...
  Scenario: Create product collection type (not authorized)
    When I request "/api/v1/EN/collectionTypes" using HTTP POST
  ...
  Scenario: Update product collection type (not authorized)
    When I request "/api/v1/EN/collectionTypes/@product_collection_type_1@" using HTTP PUT
    Then unauthorized response is received

  Scenario: Update product collection type (not found)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes/@@static_uuid@@" using HTTP PUT
  ...
  Scenario: Request product collection type (not found)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes/@@static_uuid@@" using HTTP GET
    Then not found response is received

  Scenario: Request product collection type
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes/@product_collection_type_1@" using HTTP GET
  ...
  Scenario: Get product collection type (not authorized)
    When I request "/api/v1/EN/collectionTypes" using HTTP GET
    Then unauthorized response is received

  Scenario: Get product collection type (order by code)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?field=code" using HTTP GET
  ...
  Scenario: Get product collection type (order by name)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?field=name" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": [^0]/
  ...
  Scenario: Get product collection type (filter by code)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?limit=25&offset=0&filter=code=text_" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": [^0]/
  ...
  Scenario: Get product collection type (filter by null code)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?limit=25&offset=0&filter=code=" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": 0/
  ...
  Scenario: Get product collection type (filter by name)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?limit=25&offset=0&filter=name=Name" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": [^0]/
  ...
  Scenario: Get product collection type (order ASC)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?limit=50&offset=0&order=ASC" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": [^0]/
  ...
  Scenario: Get products collection type  (order DESC)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes?limit=50&offset=0&order=DESC" using HTTP GET
    Then grid response is received
    And the response body matches:
    """
      /"filtered": [^0]/
  ...
  Scenario: Delete product collection type (not found)
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes/@@static_uuid@@" using HTTP DELETE
    Then not found response is received

  Scenario: Delete product collection type (not authorized)
    When I request "/api/v1/EN/collectionTypes/@product_collection_type_2@" using HTTP DELETE
    Then unauthorized response is received
  ...
  Scenario: Request product collection type after deletion
    Given current authentication token
    When I request "/api/v1/EN/collectionTypes/@product_collection_type_2@" using HTTP GET
    Then not found response is received
  ...
  Scenario: Delete product collection element (not authorized)
    When I request "/api/v1/EN/collections/@product_collection_1@/elements/@product_2@" using HTTP DELETE
    Then unauthorized response is received
