Feature: Product edit and inheritance value for product product with unit attribute
  ...
  Scenario: Get attribute id
    When I send a GET request to "/api/v1/en_GB/attributes?filter=code=unit_attribute_global&view=list"
    Then the response status code should be 200
  ...
  Scenario: Get product values in "pl_PL" language
    ...
    And the JSON nodes should be equal to:
      | attributes.unit_attribute_global | 100.99 |
  ...
  Scenario: Get product values in "en_GB" language
    ...
    Then the response status code should be 200
    And the JSON nodes should be equal to:
      | attributes.unit_attribute_global | 200.99 |
  ...
  Scenario: Get product values in "en_GB" language
    ...
    Then the response status code should be 200
    And the JSON nodes should be equal to:
      | attributes.unit_attribute_global | 0 |
