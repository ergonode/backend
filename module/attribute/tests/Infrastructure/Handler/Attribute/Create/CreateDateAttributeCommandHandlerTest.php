...
use Ergonode\Attribute\Infrastructure\Handler\Attribute\Create\CreateDateAttributeCommandHandler;
use Ergonode\Core\Domain\ValueObject\TranslatableString;
use PHPUnit\Framework\TestCase;
use Ergonode\SharedKernel\Domain\Bus\ApplicationEventBusInterface;

class CreateDateAttributeCommandHandlerTest extends TestCase
{
    private CreateDateAttributeCommand $command;
    ...
    {
        $this->command = $this->createMock(CreateDateAttributeCommand::class);
    ...
    public function testHandleCommand(): void
    {
        ...
        $handler = new CreateDateAttributeCommandHandler($this->repository, $this->eventBus);
