...
use Ergonode\Attribute\Infrastructure\JMS\Serializer\Handler\AttributeScopeHandler;
...
{
    /**
     * @var AttributeScopeHandler
     */
    private AttributeScopeHandler $handler;
    ...
    {
        $testValue = 'local';
        $code = new AttributeScope($testValue);
